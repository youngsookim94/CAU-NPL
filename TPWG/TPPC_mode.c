...
int main(int argc, char **argv)
{
	...
	world W = createWorld(Dom, Res, Sur, "%s-%03.1f_%.0f", argv[0], k, wLength);
	...
	putObjects(W, Au, grating, n(3.52), Si4,n(3.52), Si3,n(3.52), Si2,n(3.52), Si1, n(3.52), Substrate2, n(1.5), Substrate, Air);
